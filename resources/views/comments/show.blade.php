...
@section ('content')
	<div class="row edit-form">
		<div class="col-md-8 col-md-offset-2">
			<h3>Replies to <span class="backend-heading">{{ $comment->name }}'s</span> comment</h3>
			<hr>

	            <div class="row"><!-- comment with reply -->
	                <div class="col-md-12">
	                    <ul class="media-list">
	                        <li class="media">
	                            ...
	                            <div class="media-body">
	                                <h6 class="media-heading">{{ $comment->name }}</h6>
	                                    {{ $comment->comment }}
	                                    <p><span class="comment-post-name"><i>{{ $comment->created_at->diffForHumans() }}  3 likes</i> </span></p>
	                                    <br>
	                                            ...
	                                            <div class="media">
	                                                ...
	                                                <div class="media-body">
	                                                    <h6 class="media-heading">{{ $reply->name }}</h6>
	                                                        {{ $reply->reply }}
	                                                        <p><span class="comment-post-name"><i>{{ $reply->created_at->diffForHumans() }}  3 likes</i></span></p>
	                                                </div>
	                                            </div>
	                                        </div>
	                                        <br>
